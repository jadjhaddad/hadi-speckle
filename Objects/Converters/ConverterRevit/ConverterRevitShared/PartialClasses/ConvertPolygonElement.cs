...
public partial class ConverterRevit
{
  public ApplicationObject GisFeatureToNative(GisFeature gisFeature)
  {
    ...
    TaskDialog.Show("🧭 ConvertPolygonElement",
      $"Calling DirectShapeToNative from ConvertPolygonElement.cs\n" +
      $"SpeckleType: {speckleDirectShape.speckle_type}\n" +
      $"BaseGeometries: {speckleDirectShape.baseGeometries?.Count ?? 0}\n" +
      $"AppId: {speckleDirectShape.applicationId}");
